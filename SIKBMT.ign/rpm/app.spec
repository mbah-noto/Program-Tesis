%define name SIKBMT.ign
%define release 1
%define version 1.0
%define license GPL3
%define url http://mbah-notox.web.id
...
%description
%{description}
Sistem untuk kesehatan sebuah BMT,diambil dari KEPMEN yang paling terbaru dan akan selalu update dengan menikuti aturan kepmen tersebut
